...
export default function Header() {
  return (
    <header className="border-b border-surface-border sticky top-0">
      <div className=" h-20 px-6 flex  justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 sm:text-sm md:text-2xl font-medium">
          <Link href="/">Home</Link>
